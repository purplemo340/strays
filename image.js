const buildPalette = (colorsList) => {
  ...
  document.body.style.background=`linear-gradient(300deg, ${backColors[0]}, ${backColors[1]}, ${backColors[2]})`;
  console.log(backColors)
...
const main = (url) => {
  ...
  ///////////////////////////////////
  //const url = "https://i.scdn.co/image/ab67616d0000b27351700837cdbc6adddb88560a"
...
main(url = "https://i.scdn.co/image/ab67616d0000b27351700837cdbc6adddb88560a");
var album_divs = document.getElementsByClassName('album_div');
var url;
/* for(let i=0; i<album_divs.length; i++){
  album_divs[i].addEventListener("mouseover", function(){
    url=this.getElementsByClassName('img')[0].getAttribute('src');
    main(url);
    
  });
  }; */
  var album_link =document.getElementsByClassName("album_img")[0];
  if(album_link){
  url=album_link.getAttribute('src');
  main(url);
